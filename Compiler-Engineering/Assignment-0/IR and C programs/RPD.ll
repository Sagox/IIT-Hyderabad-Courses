...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_RPD.cpp, i8* null }]
...
define dso_local i32 @_Z4dsumx(i64 %n) #4 {
entry:
...
while.body:                                       ; preds = %while.cond
  ...
  store i32 %conv1, i32* %sum, align 4
...
define dso_local void @_Z5solvev() #5 {
entry:
...
for.cond7:                                        ; preds = %for.inc18, %for.body6
  %9 = load i32, i32* %j, align 4
  %conv8 = sext i32 %9 to i64
  %10 = load i64, i64* %N, align 8
  %cmp9 = icmp slt i64 %conv8, %10
...
for.body10:                                       ; preds = %for.cond7
  ...
  %call16 = call i32 @_Z4dsumx(i64 %conv15)
...
for.inc21:                                        ; preds = %for.end20
  ...
  store i32 %inc22, i32* %i2, align 4
  br label %for.cond3

for.end23:                                        ; preds = %for.cond3
  %20 = load i32, i32* %ans, align 4
  %call24 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %20)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_RPD.cpp() #0 section ".text.startup" {
entry:
