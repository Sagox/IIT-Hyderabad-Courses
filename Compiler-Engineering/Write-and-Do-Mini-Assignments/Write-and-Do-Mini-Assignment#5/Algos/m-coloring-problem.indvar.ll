...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx2 = getelementptr inbounds [4 x i8], [4 x i8]* %arrayidx, i64 0, i64 %indvars.iv
  %0 = load i8, i8* %arrayidx2, align 1
  %tobool = trunc i8 %0 to i1
  br i1 %tobool, label %land.lhs.true, label %if.end

land.lhs.true:                                    ; preds = %for.body
  %arrayidx4 = getelementptr inbounds i32, i32* %color, i64 %indvars.iv
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds [4 x i32], [4 x i32]* %color, i64 0, i64 %indvars.iv
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds i32, i32* %color, i64 %indvars.iv
