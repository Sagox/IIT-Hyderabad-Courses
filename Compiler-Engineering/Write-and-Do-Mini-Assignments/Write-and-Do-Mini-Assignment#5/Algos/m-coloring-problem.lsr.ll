...
entry:
  %0 = sext i32 %v to i64
  %scevgep1 = getelementptr [4 x i8], [4 x i8]* %graph, i64 %0, i64 0
  br label %for.cond
...
land.lhs.true:                                    ; preds = %for.body
  %scevgep = getelementptr i32, i32* %color, i64 %lsr.iv
  %2 = load i32, i32* %scevgep, align 4
  %cmp5 = icmp eq i32 %c, %2
...
for.body:                                         ; preds = %for.cond
  %scevgep = getelementptr [4 x i32], [4 x i32]* %color, i64 0, i64 %lsr.iv
