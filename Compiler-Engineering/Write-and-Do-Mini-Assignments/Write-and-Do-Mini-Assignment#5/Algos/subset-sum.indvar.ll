...
if.then19:                                        ; preds = %land.lhs.true14
  %5 = sext i32 %ite to i64
  %6 = sext i32 %s_size to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %if.then19
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ %5, %if.then19 ]
  %cmp20 = icmp slt i64 %indvars.iv, %6
  br i1 %cmp20, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %arrayidx22 = getelementptr inbounds i32, i32* %s, i64 %indvars.iv
  ...
  store i32 %7, i32* %arrayidx24, align 4
  %arrayidx26 = getelementptr inbounds i32, i32* %s, i64 %indvars.iv
  %8 = load i32, i32* %arrayidx26, align 4
  %add27 = add nsw i32 %sum, %8
  %cmp28 = icmp sle i32 %add27, %target_sum
  br i1 %cmp28, label %if.then29, label %if.end35

if.then29:                                        ; preds = %for.body
  %add30 = add nsw i32 %t_size, 1
  %arrayidx32 = getelementptr inbounds i32, i32* %s, i64 %indvars.iv
  %9 = load i32, i32* %arrayidx32, align 4
  %add33 = add nsw i32 %sum, %9
  %10 = add nsw i64 %indvars.iv, 1
  %11 = trunc i64 %10 to i32
  call void @_Z10subset_sumPiS_iiiii(i32* %s, i32* %t, i32 %s_size, i32 %add30, i32 %add33, i32 %11, i32 %target_sum)
  br label %if.end35
...
entry:
  ...
  call void @qsort(i8* %0, i64 %conv1, i64 4, i32 (i8*, i8*)* @_Z10comparatorPKvS0_)
...
for.end:                                          ; preds = %for.cond
  %total.0.lcssa = phi i32 [ %total.0, %for.cond ]
  %3 = bitcast i8* %call to i32*
  %arrayidx2 = getelementptr inbounds i32, i32* %s, i64 0
  %4 = load i32, i32* %arrayidx2, align 4
  %cmp3 = icmp sle i32 %4, %target_sum
  br i1 %cmp3, label %land.lhs.true, label %if.end

land.lhs.true:                                    ; preds = %for.end
  %cmp4 = icmp sge i32 %total.0.lcssa, %target_sum
  br i1 %cmp4, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  call void @_Z10subset_sumPiS_iiiii(i32* %s, i32* %3, i32 %size, i32 0, i32 0, i32 0, i32 %target_sum)
  br label %if.end
