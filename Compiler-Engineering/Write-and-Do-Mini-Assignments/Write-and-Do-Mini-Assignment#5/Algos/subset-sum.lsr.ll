...
for.body:                                         ; preds = %for.cond
  %scevgep = getelementptr i32, i32* %A, i64 %lsr.iv
...
for.cond:                                         ; preds = %for.inc, %if.then19
  %lsr.iv = phi i64 [ %lsr.iv.next, %for.inc ], [ %5, %if.then19 ]
  %tmp3 = trunc i64 %lsr.iv to i32
  %cmp20 = icmp slt i32 %tmp3, %s_size
  br i1 %cmp20, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %scevgep2 = getelementptr i32, i32* %s, i64 %lsr.iv
...
if.then29:                                        ; preds = %for.body
  ...
  %scevgep = getelementptr i32, i32* %s, i64 %lsr.iv
  %8 = load i32, i32* %scevgep, align 4
  %add33 = add nsw i32 %sum, %8
  %9 = add i64 %lsr.iv, 1
  %tmp = trunc i64 %9 to i32
  call void @_Z10subset_sumPiS_iiiii(i32* %s, i32* %t, i32 %s_size, i32 %add30, i32 %add33, i32 %tmp, i32 %target_sum)
  br label %if.end35
