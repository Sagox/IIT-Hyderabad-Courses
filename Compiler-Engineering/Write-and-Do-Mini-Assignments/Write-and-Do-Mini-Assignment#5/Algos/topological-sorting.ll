; ModuleID = './topological-sorting.cpp'
...
if.then:                                          ; preds = %for.body
  ...
  call void @_ZN5Graph19topologicalSortUtilEiPbRSt5stackIiSt5dequeIiSaIiEEE(%class.Graph* %this1, i32 %11, i8* %12, %"class.std::stack"* dereferenceable(80) %13)
  br label %if.end
...
lpad:                                             ; preds = %invoke.cont24, %invoke.cont22, %invoke.cont20, %while.body, %while.cond, %if.then, %entry
  %6 = landingpad { i8*, i32 }
          cleanup
...
if.then:                                          ; preds = %for.body7
  ...
  invoke void @_ZN5Graph19topologicalSortUtilEiPbRSt5stackIiSt5dequeIiSaIiEEE(%class.Graph* %this1, i32 %14, i8* %15, %"class.std::stack"* dereferenceable(80) %Stack)
...
invoke.cont20:                                    ; preds = %while.body
  %17 = load i32, i32* %call21, align 4
  %call23 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %17)
...
entry:
  ...
  call void @_ZNSt7__cxx1110_List_baseIiSaIiEE7_M_initEv(%"class.std::__cxx11::_List_base"* %this1) #3
  ret void
}
...
entry:
  ...
  invoke void @_ZNSt7__cxx1110_List_baseIiSaIiEE11_M_set_sizeEm(%"class.std::__cxx11::_List_base"* %this1, i64 0)
          to label %invoke.cont unwind label %terminate.lpad
...
entry:
  ...
  %call = call i8* @_ZN9__gnu_cxx16__aligned_membufImE7_M_addrEv(%"struct.__gnu_cxx::__aligned_membuf"* %this1) #3
...
entry:
  ...
  %call2 = call %"struct.std::_List_node.6"* @_ZNSt7__cxx114listIiSaIiEE14_M_create_nodeIJRKiEEEPSt10_List_nodeIiEDpOT_(%"class.std::__cxx11::list"* %this1, i32* dereferenceable(4) %call)
  store %"struct.std::_List_node.6"* %call2, %"struct.std::_List_node.6"** %__tmp, align 8
...
entry:
  ...
  call void @_ZNSt15__allocated_ptrISaISt10_List_nodeIiEEEC2ERS2_PS1_(%"struct.std::__allocated_ptr"* %__guard, %"class.std::allocator"* dereferenceable(1) %2, %"struct.std::_List_node.6"* %3) #3
  %4 = load %"class.std::allocator"*, %"class.std::allocator"** %__alloc, align 8
  %5 = load %"struct.std::_List_node.6"*, %"struct.std::_List_node.6"** %__p, align 8
  %call3 = invoke i32* @_ZNSt10_List_nodeIiE9_M_valptrEv(%"struct.std::_List_node.6"* %5)
          to label %invoke.cont unwind label %lpad
...
entry:
  ...
  %__ptr.addr = alloca %"struct.std::_List_node.6"*, align 8
  store %"struct.std::__allocated_ptr"* %this, %"struct.std::__allocated_ptr"** %this.addr, align 8
  store %"class.std::allocator"* %__a, %"class.std::allocator"** %__a.addr, align 8
  store %"struct.std::_List_node.6"* %__ptr, %"struct.std::_List_node.6"** %__ptr.addr, align 8
  ...
  %1 = load %"struct.std::_List_node.6"*, %"struct.std::_List_node.6"** %__ptr.addr, align 8
  store %"struct.std::_List_node.6"* %1, %"struct.std::_List_node.6"** %_M_ptr, align 8
  ret void
}
...
entry:
  ...
  %_M_storage = getelementptr inbounds %"struct.std::_List_node.6", %"struct.std::_List_node.6"* %this1, i32 0, i32 1
...
entry:
  ...
  %call = call %"struct.std::_List_node.6"* @_ZN9__gnu_cxx13new_allocatorISt10_List_nodeIiEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator"* %1, i64 %2, i8* null)
  ret %"struct.std::_List_node.6"* %call
}
...
entry:
  %this.addr = alloca %"struct.__gnu_cxx::__aligned_membuf.7"*, align 8
  store %"struct.__gnu_cxx::__aligned_membuf.7"* %this, %"struct.__gnu_cxx::__aligned_membuf.7"** %this.addr, align 8
  %this1 = load %"struct.__gnu_cxx::__aligned_membuf.7"*, %"struct.__gnu_cxx::__aligned_membuf.7"** %this.addr, align 8
  %call = call i8* @_ZN9__gnu_cxx16__aligned_membufIiE7_M_addrEv(%"struct.__gnu_cxx::__aligned_membuf.7"* %this1) #3
...
entry:
  ...
  store %"struct.__gnu_cxx::__aligned_membuf.7"* %this, %"struct.__gnu_cxx::__aligned_membuf.7"** %this.addr, align 8
  %this1 = load %"struct.__gnu_cxx::__aligned_membuf.7"*, %"struct.__gnu_cxx::__aligned_membuf.7"** %this.addr, align 8
  %_M_storage = getelementptr inbounds %"struct.__gnu_cxx::__aligned_membuf.7", %"struct.__gnu_cxx::__aligned_membuf.7"* %this1, i32 0, i32 0
...
entry:
  ...
  %3 = load i64, i64* %__n.addr, align 8
  call void @_ZN9__gnu_cxx13new_allocatorISt10_List_nodeIiEE10deallocateEPS2_m(%"class.__gnu_cxx::new_allocator"* %1, %"struct.std::_List_node.6"* %2, i64 %3)
  ret void
}
