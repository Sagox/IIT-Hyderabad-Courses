...
if.then:                                          ; preds = %for.body7
  invoke void @_ZN5Graph19topologicalSortUtilEiPbRSt5stackIiSt5dequeIiSaIiEEE(%class.Graph* %this, i32 %i3.0, i8* %call, %"class.std::stack"* dereferenceable(80) %Stack)
