...
new.ctorloop:                                     ; preds = %entry
  %11 = mul nsw i64 %conv, 24
  br label %arrayctor.loop

arrayctor.loop:                                   ; preds = %arrayctor.loop, %new.ctorloop
  %lsr.iv = phi i64 [ %lsr.iv.next, %arrayctor.loop ], [ %11, %new.ctorloop ]
  ...
  %lsr.iv.next1 = inttoptr i64 %lsr.iv.next to %"class.std::__cxx11::list"*
  %arrayctor.done = icmp eq %"class.std::__cxx11::list"* %lsr.iv.next1, null
...
for.cond:                                         ; preds = %for.inc, %invoke.cont
  %lsr.iv7 = phi i64 [ %lsr.iv.next8, %for.inc ], [ 0, %invoke.cont ]
  %V2 = getelementptr inbounds %class.Graph, %class.Graph* %this, i32 0, i32 0
  %1 = load i32, i32* %V2, align 8
  %tmp10 = trunc i64 %lsr.iv7 to i32
  %cmp = icmp slt i32 %tmp10, %1
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %scevgep9 = getelementptr i8, i8* %call, i64 %lsr.iv7
  store i8 0, i8* %scevgep9, align 1
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %lsr.iv.next8 = add nuw nsw i64 %lsr.iv7, 1
  br label %for.cond
...
for.cond4:                                        ; preds = %for.inc13, %for.end
  %lsr.iv = phi i64 [ %lsr.iv.next, %for.inc13 ], [ 0, %for.end ]
  %V5 = getelementptr inbounds %class.Graph, %class.Graph* %this, i32 0, i32 0
  %4 = load i32, i32* %V5, align 8
  %tmp6 = trunc i64 %lsr.iv to i32
  %cmp6 = icmp slt i32 %tmp6, %4
...
if.then:                                          ; preds = %for.body7
  ...
  invoke void @_ZN5Graph19topologicalSortUtilEiPbRSt5stackIiSt5dequeIiSaIiEEE(%class.Graph* %this, i32 %tmp, i8* %call, %"class.std::stack"* dereferenceable(80) %Stack)
...
invoke.cont20:                                    ; preds = %while.body
  %6 = load i32, i32* %call21, align 4
  %call23 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %6)
...
eh.resume:                                        ; preds = %lpad
  ...
  %lpad.val27 = insertvalue { i8*, i32 } %lpad.val, i32 %3, 1
...
lpad:                                             ; preds = %for.body
  ...
  call void @_ZNSt11_Deque_baseIiSaIiEE16_M_destroy_nodesEPPiS3_(%"class.std::_Deque_base"* %this, i32** %__nstart, i32** %__cur.0) #3
  invoke void @__cxa_rethrow() #14
