...
extern void F323_3801();
extern void F262_6382();
...
void egc_init_plug (void)
{
	...
	egc_arrmake = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) F323_3801;
	egc_strset = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE)) F232_6675;
	egc_str32set = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE)) F238_6883;
	egc_routdisp_wb = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) F262_6382;
	...
	egc_sp_bool = 0x0231;
	egc_sp_uint8 = 0x0182;
	egc_sp_uint16 = 0x015D;
	egc_sp_uint32 = 0x02D7;
	egc_sp_uint64 = 0x02F4;
	egc_sp_int8 = 0x028F;
	egc_sp_int16 = 0x02B3;
	egc_sp_int32 = 0x01A9;
	egc_sp_int64 = 0x0318;
	egc_sp_real32 = 0x020D;
	egc_sp_real64 = 0x026B;
	egc_sp_pointer = 0x0127;
	egc_sp_ref = 0x0144;
	...
	egc_system_name = "matrix_invert";
	egc_system_location = "/home/sagar/matrix_invert/EIFGENs/matrix_invert/W_code";
	egc_compiler_tag = 38;
	egc_project_version = 1540110301;
